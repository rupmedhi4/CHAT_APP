  ...
  return (
    <div className='flex h-screen items-center justify-center'>
      <form onSubmit={handleSubmit(onSubmit)} className='border border-white px-6 py-2 rounded-md space-y-3 w-96'>
        ...
        <h2 className='text-xl text-white font-bold pb-6'>Login</h2>
        ...
        <div className='flex justify-between'>
          <p>New user? <span className='text-blue-500 underline cursor-pointer ml-1'><Link to='/signup'>Signup</Link></span></p>
          <input type='submit' value='Login' className='bg-green-500 text-white px-2 py-1 cursor-pointer rounded-lg' />
        </div>
      </form>
    </div>
  );
